...
soarPath=/home/shiwali/soar-experimental/SoarSuite/out/share/java/sml.jar
className=edu.rutgers.rl3.comp.SoarMarioAgent    #Fully Qualified Name of the agent class
