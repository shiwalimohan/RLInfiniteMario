...
public class Level
{
    ...
    public static final int BIT_BLOCK_UPPER = 1 << 0;//0
    public static final int BIT_BLOCK_ALL = 1 << 1;//2
    public static final int BIT_BLOCK_LOWER = 1 << 2;//4
    public static final int BIT_SPECIAL = 1 << 3;//8
    public static final int BIT_BUMPABLE = 1 << 4;//16
    public static final int BIT_BREAKABLE = 1 << 5;//32
    public static final int BIT_PICKUPABLE = 1 << 6;//64
    public static final int BIT_ANIMATED = 1 << 7;//128
